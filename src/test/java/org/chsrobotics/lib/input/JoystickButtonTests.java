...
public class JoystickButtonTests {
    ...
    @Test
    public void JoystickButtonHasChangedWorksAsExpected() {
        assertEquals(false, button.hasChangedFromPreviousValue());
        ...
        value = false;
        assertEquals(true, button.hasChangedFromPreviousValue());
    }
}
