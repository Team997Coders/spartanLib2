...
public class AsymmetricTrapezoidProfileTests {
    ...
    AsymmetricTrapezoidProfile positiveTriangleProfile = new AsymmetricTrapezoidProfile(
    ...
    public void asymmetricPositiveTriangleTotalTime() {
        assertEquals(
                positiveTriangleProfile.totalTime(),
                1.7320508075688772, epsilon
        );
    }
    @Test
    public void asymmetricPositiveTriangleCalculate() {
        assertEquals(
                positiveTriangleProfile.calculate(0),
                new State(1.0, 0.0)
        );
        assertEquals(
                positiveTriangleProfile.calculate(0.5),
                new State(1.125, 0.5)
        );
        assertEquals(
                positiveTriangleProfile.calculate(1.1),
                new State(1.605, 1.1)
        );
        assertEquals(
        ...
        assertEquals(
                positiveTriangleProfile.calculate(2.0),
                new State(2.0, 0.0)
        );
    }
    @Test
    public void asymmetricPositiveTriangleTimeLeftUntil() {
        assertEquals(
                positiveTriangleProfile.timeLeftUntil(1),
                0.0, epsilon
        );
        assertEquals(
                positiveTriangleProfile.timeLeftUntil(1.92),
                1.4492, epsilon
        );
    }
    @Test
    ...
    AsymmetricTrapezoidProfile negativeTrapezoidProfile = new AsymmetricTrapezoidProfile(
            new Constraints(2, 1, -2),
            new State(-1, 0),
            new State(3, 0)
    );
    @Test
    ...
    public void asymmetricNegativeTrapezoidTotalTime() {
        assertEquals(
                negativeTrapezoidProfile.totalTime(),
                3.5, epsilon
        );
    }
    @Test
    public void asymmetricNegativeTrapezoidCalculate() {
        assertEquals(
                negativeTrapezoidProfile.calculate(0),
                new State(3.0, 0.0)
        );
        assertEquals(
                negativeTrapezoidProfile.calculate(0.5),
                new State(2.875, -0.5)
        );
        assertEquals(
                negativeTrapezoidProfile.calculate(1.1),
                new State(2.395, -1.1)
        );
        assertEquals(
                negativeTrapezoidProfile.calculate(3.0),
                new State(-0.75, -1.0)
        );
        assertEquals(
                negativeTrapezoidProfile.calculate(3.5),
                new State(-1.0, 0.0)
        );
    }
    @Test
    public void asymmetricNegativeTrapezoidTimeLeftUntil() {
        assertEquals(
                negativeTrapezoidProfile.timeLeftUntil(1.92),
                1.469693845669907, epsilon
        );
        assertEquals(
                negativeTrapezoidProfile.timeLeftUntil(1),
                2.0, epsilon
        );
    }
    @Test
