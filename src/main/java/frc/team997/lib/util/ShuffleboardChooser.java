...
public class ShuffleboardChooser<T> implements NTSendable, AutoCloseable {
    ...
    public static <T> ShuffleboardChooser<T> fromEnum(Class<? extends ShuffleboardOption> enumClass, ShuffleboardOption defaultOption) {
    ...
    public void initSendable(NTSendableBuilder builder) {
        ...
        builder.addStringArrayProperty("options", () -> optionMap.keySet().toArray(new String[0]), null);
