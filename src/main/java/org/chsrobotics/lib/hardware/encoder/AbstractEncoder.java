...
public abstract class AbstractEncoder implements IntrinsicLoggable {
    public abstract double getRawPosition();

    public abstract double getRawVelocity();

    public abstract double getRawAcceleration();

    public abstract double getConvertedPosition();

    public abstract double getConvertedVelocity();

    public abstract double getConvertedAcceleration();
}
